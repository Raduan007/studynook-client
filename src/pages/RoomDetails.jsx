            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              ...
              {isOwner && (
                <div className="flex items-center gap-2 shrink-0">
                  <Link
                    to={`/rooms/${id}/edit`}
                    className="inline-flex items-center gap-1.5 text-sm font-semibold border border-slate-200 text-slate-700 px-4 py-2 rounded-lg hover:bg-slate-50 transition"
                  >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-sm font-semibold border border-red-200 text-red-500 px-4 py-2 rounded-lg hover:bg-red-50 transition"
                  >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    </svg>
            ...
            <div className="sticky top-24 bg-white border border-slate-100 rounded-2xl shadow-sm p-6 space-y-5">
              ...
              {user ? (
                ...
                <Link
                  ...
                  className="block w-full text-center bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-xl transition text-sm"
                >
                  Login to Book
                </Link>
              )}
